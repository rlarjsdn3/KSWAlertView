...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TSAlertController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rlarjsdn3/TSAlertController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rlarjsdn3' => 'rlarjsdn3@naver.com' }
  s.source           = { :git => 'https://github.com/rlarjsdn3/TSAlertController.git', :tag => s.version.to_s }
